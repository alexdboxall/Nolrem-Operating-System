...
Latest release	23H2 (10.0.22631.3593) (May 14, 2024; 6 days ago[1]) [±]
Latest preview	

Release Preview Channel

23H2 (10.0.22631.3668) (May 17, 2024; 3 days ago[2][3]) [±]

Beta Channel

23H2 (10.0.22635.3640) (May 17, 2024; 3 days ago[4]) [±]

Dev Channel

24H2 (10.0.26120.670) (May 17, 2024; 3 days ago[5]) [±]

Canary Channel

24H2 (10.0.26217.5000) (May 15, 2024; 5 days ago[6]) [±]
...
As of 2024, the only active top-level family is Windows NT. The first version, Windows NT 3.1, was intended for server computing and corporate workstations. It grew into a product line of its own and now consists of four sub-families that tend to be released almost simultaneously and share the same kernel.
    ...
    Windows IoT (previously Windows Embedded): For IoT and embedded computers. The latest version is Windows 11 IoT Enterprise.[15] Like Windows Server, the main competitor of this family is Linux. (c.f. Usage share of operating systems § Market share by category)

These top-level Windows families are no longer actively developed:

    Windows 9x: Intended for the consumer market only. The first version of this family was Windows 95, which was followed by Windows 98. The last version of the Windows 9x family was Windows Me, which PC World called it as one of the worst products of all time, labeling it as "Mistake Edition" and placing it 4th in their list of Worst Tech Products in 2006.[16] All versions of this family have a monolithic kernel that uses MS-DOS as a foundation along with the kernel first used with Windows 95. Microsoft now caters to the consumer market with Windows NT starting with Windows XP.
...
Windows NT included support for several platforms before the x86-based personal computer became dominant in the professional world. Windows NT 4.0 and its predecessors supported PowerPC, DEC Alpha and MIPS R4000 (although some of the platforms implement 64-bit computing, the OS treated them as 32-bit). Windows 2000 dropped support for all platforms, except the third generation x86 (known as IA-32) or newer in 32-bit mode. The client line of the Windows NT family still ran on IA-32 up to Windows 10, with Windows 11 dropping support[63] (IA-32 was already dropped from Windows Server releases since Windows Server 2008 R2).
...
An edition of Windows 8 known as Windows RT was specifically created for computers with ARM architecture, and while ARM is still used for Windows smartphones with Windows 10, tablets with Windows RT will not be updated. Starting from Windows 10 Fall Creators Update (version 1709) and later includes support for ARM-based PCs.[71]
Windows CE
...
Xbox OS is an unofficial name given to the version of Windows that runs on Xbox consoles.[72] From Xbox One onwards it is an implementation with an emphasis on virtualization (using Hyper-V) as it is three operating systems running at once, consisting of the core operating system, a second implemented for games and a more Windows-like environment for applications.[73] Microsoft updates Xbox One's OS every month, and these updates can be downloaded from the Xbox Live service to the Xbox and subsequently installed, or by using offline recovery images downloaded via a PC.[74] It was originally based on NT 6.2 (Windows 8) kernel, and the latest version runs on an NT 10.0 base. This system is sometimes referred to as "Windows 10 on Xbox One".[75][76] Xbox One and Xbox Series operating systems also allow limited (due to licensing restrictions and testing resources) backward compatibility with previous generation hardware,[77] and the Xbox 360's system is backwards compatible with the original Xbox.[78]
Version control system

Up to and including every version before Windows 2000, Microsoft used an in-house version control system named Source Library Manager (SLM). Shortly after Windows 2000 was released, Microsoft switched to a fork of Perforce named Source Depot.[79] This system was used up until 2017 once the system could not keep up with the size of Windows.[citation needed] Microsoft had begun to integrate Git into Team Foundation Server in 2013,[80] but Windows (and Office) continued to rely on Source Depot.[81] The Windows code was divided among 65 different repositories with a kind of virtualization layer to produce unified view of all of the code.[citation needed]

In 2017 Microsoft announced that it would start using Git, an open source version control system created by Linus Torvalds and in May 2017 they reported that the migration into a new Git repository was complete.[82][83][56]
VFSForGit
...
In 2021 the VFS for Git has been superseded by Scalar.[85]
Timeline of releases
...
As a percentage of desktop and laptop systems using Microsoft Windows,[89] according to StatCounter data as of April 2024.[90]
...
Leaked documents from 2013 to 2016 codenamed Vault 7 detail the capabilities of the CIA to perform electronic surveillance and cyber warfare,[105] such as the ability to compromise operating systems such as Windows.[106]
...
"May 14, 2024—KB5037771 (OS Builds 22621.3593 and 22631.3593)". Microsoft Support. Microsoft.
"Releasing Windows 11 Builds 22621.3668 and 22631.3668 to the Release Preview Channel". Windows Insider Blog. May 17, 2024.
"May 14, 2024—KB5037771 (OS Builds 22621.3593 and 22631.3593)". Microsoft Support. Microsoft.
"Announcing Windows 11 Insider Preview Build 22635.3640 (Beta Channel)". Windows Insider Blog. May 17, 2024.
"Announcing Windows 11 Insider Preview Build 26120.670 (Dev Channel)". Windows Insider Blog. May 17, 2024.
"Announcing Windows 11 Insider Preview Build 26217 (Canary Channel)". Windows Insider Blog. May 15, 2024.
Su, Christy; Xu, Simonx (November 25, 2021). "FAQ about the Windows Installer .msp files - Dynamics GP". Microsoft Learn. Retrieved September 13, 2023.
dianmsft; Jenks, Alma; Coulter, David; Schofield, McLean; Vintzel, John; Satran, Michael; Donthini, Chaitanya; Kinsman, Mike (December 30, 2021). "What is MSIX?". Microsoft Learn. Retrieved September 13, 2023.
Jahiu, Dhurata; Jenks, Alma; v-chmccl; Power, Cory; Coulter, David; Schofield, McLean; Donthini, Chaitanya; Satran, Michael (April 13, 2022). "How to bundle MSIX packages". Microsoft Learn. Retrieved September 13, 2023.
Vera (June 26, 2023) [April 14, 2023]. "How to Install MSIXBundle on Windows 10/11? 2 Ways to Try!". MiniTool. Retrieved September 13, 2023.
...
Chen, Raymond (July 22, 2019). "What was the code name for Windows 7?". The Old New Thing. Archived from the original on September 26, 2021. Retrieved October 6, 2021.
"Windows 11 Home and Pro Product Life Cycle". Microsoft. September 20, 2022. Retrieved February 14, 2023.
"Frequently Asked Questions". StatCounter. Are laptops included in the desktop platform?.
"Desktop Windows Version Market Share Worldwide (April 2024)". StatCounter.
...
"Desktop Operating System Market Share Worldwide: August 2021". StatCounter. Archived from the original on January 27, 2020. Retrieved September 8, 2021.
...
Russinovich, Mark (April 30, 1998). "Windows NT Security, Part 1". ITPro Today: IT News, How-Tos, Trends, Case Studies, Career Tips, More. Archived from the original on September 29, 2022. Retrieved September 29, 2022.
...
Categories:
    ...
    Microsoft Windows1985 softwareComputing platformsMicrosoft franchisesPersonal computersMicrosoft operating systemsOperating system familiesProducts introduced in 19851985 establishments in the United States

    This page was last edited on 14 May 2024, at 23:54 (UTC).
